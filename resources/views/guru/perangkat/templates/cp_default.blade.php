<div style="font-family: Arial, sans-serif; font-size: 12pt; line-height: 1.5; color: #000;">
    ...
    <div class="mceEditable" style="min-height: 400px; padding: 10px; border: 1px dashed #ccc;">
        ...
        <table style="width: 100%; border: none;">
            <tr>
                ...
                <td style="width: 40%; text-align: left;">
                    ...
                    <br><br><br><br>
                    <p style="margin: 0; font-weight: bold;">{{ $perangkatGuru->guru->name ?? Auth::user()->name ?? '<<nama_guru>>' }}</p>
