<div style="font-family: 'Times New Roman', serif; font-size: 12pt; line-height: 1.5; color: #000;">
    <div class="mceNonEditable" style="background:#306D29; padding:12px; color: #f8f8f8ff; margin-bottom: 20px;">
        <div style="text-align: center;">
            <p style="margin: 0;"><strong>TUJUAN PEMBELAJARAN (TP)</strong></p>
    ...
    <div class="mceEditable">
        ...
        <table style="width: 100%;">
            <tr style="text-align: center;">
                <td style="width: 15%;"><strong>ELEMEN</strong></td>
                <td style="width: 35%;"><strong>CAPAIAN PEMBELAJARAN (CP)</strong></td>
                <td style="width: 15%;"><strong>KOMPETENSI</strong></td>
                <td style="width: 15%;"><strong>LINGKUP MATERI</strong></td>
