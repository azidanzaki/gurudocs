...
return [
    ...
    */
    ...
    <div style="line-height:1.1">
        <div><b>Dokumen Adm Guru</b></div>
        <div style="font-size:11px; opacity:0.8">MTsN 03 Rohul</div>
    </div>
',
    'logo_img' => 'images/logomts.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'MTs Logo',
    ...
    */
    ...
    'preloader' => [
        ...
        'text' => '<div style="margin-top:10px; font-size:14px;">
